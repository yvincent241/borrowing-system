using BorrowingSystem.Data;using Microsoft.EntityFrameworkCore;using System.Linq.Expressions;

namespace BorrowingSystem.Repositories{public class Repository<T> : IRepository<T> where T : class{
...
public async Task DeleteAsync(int id){var entity = await GetByIdAsync(id);if (entity != null){_dbSet.Remove(entity);}}
